...
class Login(object):
    ...
    def __init__(self, root):
        self._images.append(tkinter.PhotoImage('icon_lock_key.gif', file = os.path.dirname(__file__) + '/icon_lock_key.gif'))
        ...
        self._label_2 = tkinter.Label(root,
            activebackground = "#ffa4a6",
            background = "#ffa4a6",
            font = "{Gill Sans Ultra Bold} 24 bold",
            text = "Login",
        )
        ...
        self.password = tkinter.Entry(self._frame_2,
            insertwidth = 4,
            width = 50,
            show="*"
        )
        self.username = tkinter.Entry(self._frame_1,
            insertwidth = 4,
            width = 50,
        )
    ...
    def login_command(self):
        try:
            ...
            if self.username.get()=="" or self.password.get()=="":
                ...
                messagebox.showerror("Error!⚠️","Enter all the details before proceeding...!!")
            else:
                ...
                if flag == 0:
                    ...
                    if self.password.get() == str(record[i][1]):
                        ...
                        self.demo = index.travel(self.newwindow)                       
                        pass
